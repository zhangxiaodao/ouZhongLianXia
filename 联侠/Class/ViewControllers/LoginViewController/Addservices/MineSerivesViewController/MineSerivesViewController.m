...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([model.devTypeSn isEqualToString:@"4131"] || [model.devTypeSn isEqualToString:@"4132"]) {
        ...
        lengFengShanVC.indexPath = [[NSIndexPath alloc]init];
        lengFengShanVC.indexPath = indexPath;
        ...
        testAirDeviceVC.indexPath = [[NSIndexPath alloc]init];
        testAirDeviceVC.indexPath = indexPath;
        ...
        ganYiJiVC.indexPath = [[NSIndexPath alloc]init];
        ganYiJiVC.indexPath = indexPath;
